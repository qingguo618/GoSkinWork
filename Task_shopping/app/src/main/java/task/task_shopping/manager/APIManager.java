package task.task_shopping.manager;
...
import task.task_shopping.CustomHttpClient.SSLSocketFactoryEx;
import task.task_shopping.Preference.UserPreference;
import task.task_shopping.utils.Constant;
